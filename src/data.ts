...
export const ACTUAL_DATA: ActualDataPoint[] = [
  ...
  { year: 2022, tax: 71.1, interest: 8.0, debt: 1005, policyExp: 67.4, totalRevenue: 86.6, totalCost: 75.4, fiscalBalance: 11.2, interestBurden: 11.3, avgCoupon: 0.8, bojPayment: 2.0, taxConsumption: 23.1, taxIncome: 22.5, taxCorporate: 14.9, taxOther: 10.6, exchangeRate: 131, exportAmount: 98.2, importAmount: 118.2, tradeBalance: -20.0, povertyRate: 15.5, giniIndex: 0.335, realWageGrowth: -1.0, currentAccount: 11.5, nfa: 419 },
  { year: 2023, tax: 72.1, interest: 8.1, debt: 1068, policyExp: 72.7, totalRevenue: 87.6, totalCost: 80.8, fiscalBalance: 6.8, interestBurden: 11.2, avgCoupon: 0.8, bojPayment: 2.2, taxConsumption: 23.2, taxIncome: 22.0, taxCorporate: 14.6, taxOther: 12.3, exchangeRate: 141, exportAmount: 100.9, importAmount: 110.2, tradeBalance: -9.3, povertyRate: 15.4, giniIndex: 0.334, realWageGrowth: -2.5, currentAccount: 22.6, nfa: 471 },
  { year: 2024, tax: 75.2, interest: 9.6, debt: 1103, policyExp: 73.5, totalRevenue: 90.6, totalCost: 83.1, fiscalBalance: 7.5, interestBurden: 12.8, avgCoupon: 0.9, bojPayment: 2.2, taxConsumption: 23.8, taxIncome: 22.4, taxCorporate: 17.0, taxOther: 12.0, exchangeRate: 150, exportAmount: 104.1, importAmount: 112.6, tradeBalance: -8.5, povertyRate: 15.4, giniIndex: 0.334, realWageGrowth: -0.2, currentAccount: 29.3, nfa: 533 },
];
