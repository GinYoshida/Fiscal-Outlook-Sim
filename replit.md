...
- ウォーターフォール分析（2015〜2055年度対応、実績/シミュレーション切替、税収4区分表示）
...
## Recent Changes
- 2026-02-22: 2タブ構成に再編（解説タブ + シミュレーションタブ）
- 2026-02-22: 転置データ表（行=項目の階層構造、列=年度）に変更
- 2026-02-22: 消費税率変更シナリオ追加（年度指定で税率変更可能）
- 2026-02-22: 国債発行額の自動計算追加
- 2026-02-22: その他収入を4項目に分割（印紙収入・官業収入・資産売却・雑収入）
- 2026-02-22: 解説タブに計算ロジックツリー・変数解説・統合政府の仕組み統合
- 2026-02-22: メイン3チャート常時表示、その他チャートを折りたたみに変更
