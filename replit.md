...
- ウォーターフォール分析タブ（2015〜2055年度対応、実績/シミュレーション切替、税収4区分表示）
...
## Recent Changes
- 2026-02-22: 税収4区分シミュレーション実装（消費税・所得税・法人税・その他税を個別弾性値で推計）
- 2026-02-22: 税収内訳の積み上げ棒グラフ追加（実績+シミュレーション）
- 2026-02-22: ウォーターフォールチャートを税収4区分に対応
