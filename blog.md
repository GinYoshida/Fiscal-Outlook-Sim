# 生成AIで「統合政府 財政シミュレーター」を作ってみた——30年後の日本の財政を可視化する
...
## 開発の過程——5つのフェーズとプロンプト例

開発環境にはReplitを使用し、生成AIとの対話だけでアプリを構築していった。全体で約7,500行、27ファイルのコードベースが2週間ほどで完成した。以下、開発フェーズごとにプロンプト例とその成果を紹介する。
...
ビルドサイズを維持したまま（JS: 835kB, CSS: 23kB）、27ファイルの整理されたコードベースが完成した。
...
**開発期間:** 約2週間（2026年2月12日〜28日）

**コード規模:** 約7,500行 / 27ファイル
